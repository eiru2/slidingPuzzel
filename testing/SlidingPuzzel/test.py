...
noise = perlin_noise_3d((100,100,100),(10,10,10))

iterations = 1000000
start = time.time()
for i in range(iterations):
    trilinear_interpolation(noise, i * 0.123, i * 0.456, i * 0.789)
...
start = time.time()
for i in range(iterations):
    result = fast_noise.trilinear_interpolation(noise, i * 0.123, i * 0.456, i * 0.789)
