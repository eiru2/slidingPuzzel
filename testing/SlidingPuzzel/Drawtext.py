...
class Text:
    def __init__(self, pos:list,text:str, font:str=None ,fontSize:int=45, fontColor:tuple=(255,255,255)):
...
class Text_FPS(Text):
    ...
    def __init__(self, pos, text, font = None, fontSize = 45, fontColor = (255,255,255)):
